...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./reset.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./reset.css");
...
var Converter = function () {
  ...
  (0, _createClass3.default)(Converter, [{
    ...
    value: function bindEvents() {
      document.querySelector('.j-currency-entered').addEventListener('input', this.exchangeCurrency);
      document.querySelector('.j-currency-from').addEventListener('change', this.exchangeCurrency);
    }
  }, {
    key: 'exchangeCurrency',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
        var calculatedInput, caluclatedCurrency;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                calculatedInput = document.querySelector('.j-currency-calculated');
                _context.next = 3;
                return this.calculateCurrency();

              case 3:
                caluclatedCurrency = _context.sent;
    ...
    key: 'calculateCurrency',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2() {
        var enteredInput, currencyFrom, currencyTo, exchangeRatio;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                enteredInput = document.querySelector('.j-currency-entered');
                currencyFrom = document.querySelector('.j-currency-from').value;
                currencyTo = document.querySelector('.j-currency-to').value;
                _context2.next = 5;
                return this.fetchCurrencyRatio(currencyFrom, currencyTo);

              case 5:
                exchangeRatio = _context2.sent;
                return _context2.abrupt('return', enteredInput.value * exchangeRatio);
    ...
    key: 'fetchCurrencyRatio',
    value: function fetchCurrencyRatio(currencyFrom, currencyTo) {
      var url = 'http://api.fixer.io/latest?base=' + currencyFrom;

      return fetch(url).then(function (response) {
        return response.json();
      }).then(function (data) {
        var rates = data.rates;
        var currency = currencyTo.toUpperCase();
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./converter.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./converter.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".converter {\n  display: flex;\n  flex-wrap: wrap;\n  width: 50%;\n  min-width: 500px;\n  margin: 0 auto;\n  padding: 50px;\n  border: 1px solid #1c0790;\n  border-radius: 10px; }\n  .converter__box {\n    flex-basis: 100%;\n    margin-bottom: 20px;\n    position: relative;\n    /* for currency select */ }\n  .converter__input {\n    padding: 5px;\n    font-size: 14px;\n    border: 1px solid #ccc;\n    height: 30px; }\n  .converter__span {\n    display: inline-block;\n    width: 100px; }\n  .converter__select {\n    width: 65px;\n    height: 30px;\n    border: 1px solid #ccc; }\n", ""]);
